...
ABaseGun::ABaseGun()
{
	...
	//Collider->OnComponentBeginOverlap.AddDynamic(this, &ABaseGun::YourOverlapFunction);
	OnActorBeginOverlap.AddDynamic(this, &ABaseGun::OnOverlap);
	OnActorEndOverlap.AddDynamic(this, &ABaseGun::OnOverlapEnd);
}
...
//void ABaseGun::YourOverlapFunction(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult) {
